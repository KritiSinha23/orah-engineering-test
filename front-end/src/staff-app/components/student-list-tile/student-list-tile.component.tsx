...
export const StudentListTile: React.FC<Props> = ({ studentId, isRollMode, student, rollState }) => {
  return (
    <S.Container>
      ...
      {isRollMode && (
        <S.Roll>
          <RollStateSwitcher studentId={studentId} rollStateFunc={rollState} rollMarkedAs={student.roll_state} />
        </S.Roll>
      )}
    </S.Container>
  )
